...
namespace FormalBlog.Core.Services
{
    public class User
    {
        ...
        public Response GetAll(int PageNo, int PageSize, string Search)
        {
            Response Response = new Response();
        ...
        public Response Create(Infrastructure.ViewModels.User.Signup model)
        {
            Response Response = new Response();
            Infrastructure.Models.User User = new Infrastructure.Models.User();
            ...
            try
            {
                ...
                {
                    Response.Status = "Error";
                    Response.Message = "You have already registered with us. Please login to your account.";
                    Response.Output = null;
        ...
        public Response Update(Infrastructure.Models.User model)
        {
            Response Response = new Response();
            Infrastructure.Models.User User = new Infrastructure.Models.User();
        ...
        public Response NewPassword(string GUID, DateTime ResetPasswordCodeDate, string NewPassword)
        {
            Response Response = new Response();
            Infrastructure.Models.User User = new Infrastructure.Models.User();
            try
        ...
        public Response ResentEmail(string Email)
        {
            Response Response = new Response();
            Infrastructure.Models.User User = new Infrastructure.Models.User();
            try
